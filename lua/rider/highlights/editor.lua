...
function M.setup(colors, config)
    ...
    return {
        ...
        -- Normal		Normal text.
        Normal = { fg = theme.syn.identifier, bg = not config.transparent and theme.ui.bg or "NONE" },
        -- NormalFloat	Normal text in floating windows.
        NormalFloat = { fg = theme.syn.identifier, bg = theme.ui.float.bg },
